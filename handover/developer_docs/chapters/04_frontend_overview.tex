...
Detailed component references are provided in Section~\ref{sec:frontend:components} (to be added), with links back to relevant backend API endpoints in Section~\ref{sec:api} (to be added).
