...
SELECT has_column('exam', 'exam_length');
SELECT col_not_null('exam', 'start_time');
SELECT col_not_null('exam', 'course_code');
SELECT has_column('exam', 'exam_type');
SELECT has_column('exam', 'no_students');
SELECT has_column('exam', 'date_exam');

SELECT col_is_pk('venue', 'venue_id');
...
SELECT fk_ok('examvenue', 'venue_id', 'venue', 'venue_id');

SELECT fk_ok('studentexam', 'student_id', 'student', 'student_id');
SELECT fk_ok('studentexam', 'exam_id', 'exam', 'exam_id');
SELECT col_is_pk('studentexam', ARRAY['student_id', 'exam_id']);
